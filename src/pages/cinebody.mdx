    ...
    aside={[
        {
            ...
            headline: 'More Info',
            items: [
                '[Cinebody](https://www.cinebody.com/)'
            ]
        }
    ]}
    darkBg
...
<CaseStudyConclusion
    headline="Results"
    text="Since launch Cinebody has gained traction in partnerships with Nike, Red Bull, and Tropicana among other clients. Cinebody has also raised a $1.3 million seed round, and has achieved and average MRR in the six figures."
/>
