...
import StickyText, { StickyColumn, StaticColumn } from '../components/StickyText/StickyText'
...
import colorCol from './spruce-labs/Color-Col@2x.png'
...
<StickyText>
    <StickyColumn>
        <h2>A More Expansive Color Palette</h2>
    </StickyColumn>
    <StaticColumn>
        <img src={colorCol} />
    </StaticColumn>
